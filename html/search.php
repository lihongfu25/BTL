                ...
                <li class="header__nav--item">
                    ...
                    <div class="header__nav--menu2">
                        <ul class="header__nav--menu2--list">
                            ...
                            <li class="header__nav--menu2--item"><a href="" class="header__nav--menu2--link">Hải Dương</a></li>
                            <li class="header__nav--menu2--item"><a href="" class="header__nav--menu2--link">Mộc Châu</a></li>
                            <li class="header__nav--menu2--item"><a href="" class="header__nav--menu2--link">Hà Giang</a></li>
                        </ul>
                        <ul class="header__nav--menu2--list">
        ...
        <div class="header__user">
            ...
            <div class="header__user--menu">
                <div class="header__user--menu--heading">
                    <img src="../assets/img/sticker/user.jpg" alt="" class="header__user--menu--heading--avt">
                    <div class="header__user--menu--heading--name">Lê Hồng Phú</div>
                </div>
                <ul class="header__user--menu--list">
                    <li class="header__user--menu--item">
                        <a href="" class="header__user--menu--link">Trang cá nhân</a>
                    </li>
                    <li class="header__user--menu--item">
                        <a href="" class="header__user--menu--link">Địa điểm yêu thích</a>
                    </li>
                    <li class="header__user--menu--item">
                        <a href="" class="header__user--menu--link">Cài đặt</a>
                    </li>
                    <li class="header__user--menu--item">
                        <a href="" class="header__user--menu--link">Đăng xuất</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="footer__contact">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span>mtptravel.work@gmail.com</span>
                            </li>
                        </ul>
